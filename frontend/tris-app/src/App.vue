...
export default {
  data() {
    return {
      ...
      currentPlayer: "",
      winner: null,
      url: "https://e11b-78-209-188-199.ngrok-free.app" // Changes everytime a new tunnel is created
    };
  },
  mounted() {
    ...
    async submitName() {
      if (this.nameSubmitted === true) {
        ...
        try {
          ...
          this.nameSubmitted = true; // Reset nameSubmitted to allow resubmission
        }
      }
    },
    ...
    async makeMove(index) {
      ...
      if (this.moveMade === true) {
        ...
        try {
          ...
          await axios.post(this.url +"/get_optimality_comment", {optimal: optimal} , {headers: {'ngrok-skip-browser-warning': 'true'}});
